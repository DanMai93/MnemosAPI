    ...
    public class ProjectService : IProjectService
    {
        ...
        public async Task<ProjectDto> CreateProjectAsync(AddProjectRequestDto addProjectRequestDto)
        {
            ...
            var projectDto = new ProjectDto()
            {
                ...
                Difficulty = addedProject.Difficulty != "" ? Enum.Parse<DifficultiesEnum>(addedProject.Difficulty) : null,
                Status = addedProject.Status != "" ? Enum.Parse<StatusesEnum>(addedProject.Status) : null,
